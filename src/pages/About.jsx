    ...
    <>
      <main className="container" style={{ paddingTop: '130px' }} ref={containerRef}>
        ...
        <header className="about-header reveal">
          <h1 className="about-title" style={{ fontSize: 'clamp(32px, 5vw, 64px)', fontWeight: 800, letterSpacing: '-0.04em', color: 'var(--white)' }}>
            About &amp; Experience
          </h1>
          <p className="about-subtitle" style={{ fontSize: '16px', color: 'var(--muted)', marginTop: '8px', maxWidth: '600px', marginBottom: '40px' }}>
            A summary of my professional background, core technical skills, and career timeline.
          </p>
        </header>
        ...
        <div className="bento">
          ...
          {/* Row 4: Skills (Full Width with new internal skills-grid styling) */}
